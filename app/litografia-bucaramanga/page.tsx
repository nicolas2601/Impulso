          ...
          <div>
             ...
             <div className="grid grid-cols-2 gap-4">
               {['Revistas y Catálogos', 'Cajas Plegadizas', 'Afiches B1', 'Etiquetas en Rollo', 'Libros', 'Carpetas'].map((item, i) => (
                 <div key={i} className="p-4 bg-white shadow-sm border border-gray-100 rounded-lg text-center font-medium hover:border-impulso-blue transition-colors cursor-default">
                   {item}
                 </div>
               ))}
             </div>
