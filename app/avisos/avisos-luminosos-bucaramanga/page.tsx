...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://tikno.pro/avisos/avisos-luminosos-bucaramanga',
  },
};
          ...
          <div>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={idx} className="border-l-4 border-tikno-yellow pl-6 py-2">
                  <h3 className="font-bold text-lg">{item.title}</h3>
                  <p className="text-gray-600 text-sm mb-1">{item.desc}</p>
                  <span className="text-tikno-blue font-bold text-sm">{item.price}</span>
                </div>
              ))}
            </div>
          </div>
