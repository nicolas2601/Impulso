...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://tikno.pro/avisos/avisos-acrilico-precios',
  },
};
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  <th className="p-4 font-bold text-tikno-gray-dark">Tamaño</th>
                  <th className="p-4 font-bold text-tikno-gray-dark hidden md:table-cell">Uso Recomendado</th>
                  <th className="p-4 font-bold text-tikno-gray-dark">Precio Desde</th>
                  <th className="p-4"></th>
                </tr>
              </thead>
              <tbody>
                {priceTable.map((row, idx) => (
                  <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="p-4 font-bold text-tikno-blue text-lg">{formatPrice(row.price)}</td>
                    <td className="p-4">
                      <Button 
                        variant="ghost" 
