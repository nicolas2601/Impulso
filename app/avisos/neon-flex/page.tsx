...
export const metadata: Metadata = {
  title: 'Letreros Neón Flex Personalizados | Tikno Bucaramanga',
  ...
  alternates: {
    canonical: 'https://tikno.pro/avisos/neon-flex',
  },
};
           ...
           <div>
             ...
             <ul className="space-y-4 text-gray-300">
               <li className="flex items-center gap-3">
                 <span className="w-3 h-3 rounded-full bg-tikno-yellow"></span>
