...
export const metadata: Metadata = {
  title: 'Diseño Gráfico para Empaques y Packaging | Tikno',
  ...
  alternates: {
    canonical: 'https://tikno.pro/diseno-empaques',
  },
};
    ...
    <main>
      ...
      <Section>
        <div className="max-w-4xl mx-auto prose prose-lg text-gray-600">
          <p className="lead text-2xl text-tikno-gray-dark font-light mb-8">
            Un buen diseño no es solo poner el logo en la caja. Es psicología, funcionalidad y branding trabajando juntos.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 my-12">
            <div>
              <h3 className="text-xl font-bold text-tikno-gray-dark mb-4">Lo que hacemos</h3>
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              <h3 className="text-xl font-bold text-tikno-gray-dark mb-4">El Proceso Creativo</h3>
          ...
          <div className="bg-tikno-blue/5 border-l-4 border-tikno-blue p-8 my-12">
            <h3 className="text-tikno-blue font-bold text-xl mb-2">¿Ya tienes quien imprima?</h3>
