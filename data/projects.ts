...
export const projects: ProjectData[] = [
  ...
  {
    id: '3',
    title: 'Kit Emprendedor Moda',
    slug: 'kit-emprendedor-tienda-ropa',
    client: 'Velvet Store',
    category: 'Kits',
    imageUrl: 'https://images.unsplash.com/photo-1556740738-b6a63e27c4df?q=80&w=800&auto=format&fit=crop',
    description: 'Paquete completo de inicio para boutique de ropa femenina.',
    challenge: 'Presupuesto ajustado para inauguración.',
    solution: 'Kit Emprendedor Pro: Tarjetas, etiquetas de ropa, bolsas y aviso acrílico.',
    images: ['https://images.unsplash.com/photo-1556740738-b6a63e27c4df'],
    relatedServices: ['/kits-emprendedor-publicidad', '/papeleria-comercial'],
  },
  {
    id: '4',
